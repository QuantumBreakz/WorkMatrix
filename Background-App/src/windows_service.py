...
class WorkMatrixService(win32serviceutil.ServiceFramework):
    _svc_name_ = "WorkMatrixService"
    _svc_display_name_ = "WorkMatrix Background Service"
    _svc_description_ = "Manages background data collection and synchronization for WorkMatrix"
...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        ...
        servicemanager.PrepareToHostSingle(WorkMatrixService)
        servicemanager.StartServiceCtrlDispatcher()
    else:
        win32serviceutil.HandleCommandLine(WorkMatrixService) 